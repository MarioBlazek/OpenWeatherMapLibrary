...
class HourForecastHydratorTest extends TestCase
{
    ...
    public function testHydrate()
    {
        ...
        $this->internalHydrator->expects(self::exactly(6))
            ->method('hydrate');
        ...
        self::assertSame($response, $result);
        self::assertSame($data['cnt'], $result->count);
    }
    ...
    public function testHydrateWithRawData()
    {
        ...
        $this->internalHydrator->expects(self::exactly(224))
            ->method('hydrate');

        $this->hydrator->hydrate($data, $response);

        self::assertSame(40, $response->count);
    }
}
