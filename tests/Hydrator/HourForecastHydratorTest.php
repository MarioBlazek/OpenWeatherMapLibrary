...
class HourForecastHydratorTest extends TestCase
{
    /**
    ...
    public function setUp()
    {
        ...
        $this->hydrator = new HourForecastHydrator($this->internalHydrator);
    }

    public function testHydrateWithResponseNotAggregatedHourForecast()
    {
        $data = [];
