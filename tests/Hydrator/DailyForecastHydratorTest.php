...
class DailyForecastHydratorTest extends TestCase
{
    ...
    public function testHydrate()
    {
        ...
        $this->internalHydrator->expects($this->exactly(5))
            ->method("hydrate");
        ...
        $this->assertSame($response, $result);
        $this->assertEquals($data['list'][0]['deg'], $result->list[0]->deg);
    }
    ...
    public function testHydrateWithRawData()
    {
        ...
        $this->internalHydrator->expects($this->exactly(29))
            ->method("hydrate");
        ...
        $this->assertSame($response, $result);
        $this->assertEquals(276, $result->list[0]->deg);
    }
}
